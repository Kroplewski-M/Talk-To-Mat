...
<body>
    <section class="max-w-[800px] h-[90vh] mx-auto rounded-md bg-purple-900 mt-10 mb-[50px] pb-10 md:pb-0">
        ...
        <div class="messages w-[90%] h-[88%] bg-[#111111] mx-auto rounded-md relative pt-5">
            ...
            <div class="max-w-[300px] min-h-[100px] rounded-md bg-purple-800 ml-5 pl-[5px] pb-5">
            ...
            <div class="max-w-[300px] min-h-[100px] rounded-md bg-purple-800 ml-5 pl-[5px] pb-5 mt-5">
            ...
            <div class="w-[100%] min-h-[150px]">
                <div class="max-w-[300px] min-h-[100px] rounded-md bg-blue-800 ml-5 pl-[5px] pb-5 mt-5 float-right mr-5">
